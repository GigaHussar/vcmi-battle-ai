...
np.save(os.path.join(h3ai_dir, "battlefield_tensor.npy"), tensor_battlefield)
np.save(os.path.join(h3ai_dir, "creature_id_tensor.npy"), creature_id_matrix)
np.save(os.path.join(h3ai_dir, "faction_id_tensor.npy"), faction_id_matrix)
